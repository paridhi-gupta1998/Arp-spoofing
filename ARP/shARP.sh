...
#==================================================================================================================================================
 ...
 gtping=`ping _gateway -c 1`
#echo $gtping
 gtping=${gtping%_gateway*} #retain the part before gateway
 gtping=${gtping%_gateway*} #retain the part before gateway
gtping=${gtping%_gateway*} #retain the part before gateway
gtping=${gtping%_gateway*} #retain the part before gateway
 ...
 echo $gtping
 if [ " $gtping " = " PING  " ] ; then 
  MYVAR=`sudo arp _gateway -i $interface `
 ...
 echo $add
  ...
  echo  $(date +"%D") ": DEFENSIVE MODE : The original address of the gateway is " $add
  #arp gateway -i $interface
  arpout=`arp _gateway -i $interface`
  echo ............................................................................................................................................
  arpd=$add
  carpd=$arpd
  carpd=${carpd//[ ]/}
  ...
  echo ........................................................................................................................................... 
	while true
		   do
			output=`sudo arp _gateway -i $interface`
                       # echo $output
